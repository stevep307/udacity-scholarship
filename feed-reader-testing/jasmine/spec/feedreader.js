...
$(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
         ...
         */
        it('exist after loadFeed() was called', function(done) {
    ...
    describe('New Feed Selection', function() {
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                prevContent = document.querySelector('.feed h2').textContent;
                done();
            });
        });
        ...
        beforeEach(function(done) {
            loadFeed(1, function() {
                currentContent = document.querySelector('.feed h2').textContent;
                done();
            });
        });
        ...
        it('actually changes content', function(done) {
            expect(prevContent).not.toBe(currentContent);
            done();
        });
    });
}());
